          ...
          <div className="divide-y divide-gray-100">
            {data.length === 0 ? (
              ...
              data.map((album, index) => (
                <div
                  className="grid grid-cols-12 gap-4 items-center px-4 py-6 hover:bg-gradient-50 transition-colors duration-200"
                  key={index}
                >
                  ...
                  <div className="col-span-3">
                    <p className=" text-gray-900 truncate ">{album.desc}</p>
                  </div>
                  <div className="col-span-2">
